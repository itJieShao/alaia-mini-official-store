    ...
    <view class="container">
      <swiper class="swiper" :current="current" easing-function="linear" :autoplay="false" :indicator-dots="false"
        ...
        <swiper-item class="scroll-view">
          <!-- 首页顶部swiper -->
          <home-head-swiper :pageIsShow="pageIsShow" :parentCurrent="current" :homeHeadSwiperList="homeHeadSwiperList"
            :isPause="isPause" :isShowDost="isShowDost" @swiperChange="homeHeaderSwiperChange"></home-head-swiper>
        </swiper-item>
        <swiper-item>
